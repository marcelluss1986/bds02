...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DependentComponentException.class)
	public ResponseEntity<StandardError> dependentComp(DependentComponentException e, HttpServletRequest request){
